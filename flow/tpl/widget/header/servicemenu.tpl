...
<div class="header-buttons-item">
    <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account_wishlist"}]" class="header-buttons-item__link">
        <div class="header-buttons-item__value">0</div>
        <div class="header-buttons-item__icon icon-favorite"></div>
        <div class="header-buttons-item__title">
            Избранное
        </div>
    </a>
</div>
...
<div class="header-buttons-item">
    <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=compare"}]" class="header-buttons-item__link">
        [{if $oView->getCompareItemsCnt()}]
                <div class="header-buttons-item__value">[{$oView->getCompareItemsCnt()}]</div>
        [{else}]
                <div class="header-buttons-item__value">0</div>
        [{/if}]
        <div class="header-buttons-item__icon icon-comparison"></div>
        <div class="header-buttons-item__title">
            Сравнение
        </div>
    </a>
