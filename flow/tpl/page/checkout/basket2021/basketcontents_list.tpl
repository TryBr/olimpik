    ...
    [{foreach key=basketindex from=$oxcmp_basket->getContents() item=basketitem name=basketContents}]
        [{block name="checkout_basketcontents_basketitem"}]
            ...
            <li id="list_cartItem_[{$smarty.foreach.basketContents.iteration}]">
                    ...
                    <div class="col-md-3 col-xs-12">
                        [{if $editable}]
                            <div class="text-right">
                                <a data-toggle="collapse" href="#collapseExample_[{$basketindex}]" role="button" aria-expanded="false" aria-controls="collapseExample_[{$basketindex}]">
                ...
                <div class="row collapse" id="collapseExample_[{$basketindex}]">
                    <div class="col-xs-3">
